...
python3 run_pretraining.py \
 ...
 --init_checkpoint=gs://nlp-data-storage/poleval/test_v3_without_next_sentence_2a \
 --output_dir=gs://nlp-data-storage/poleval/test_v3_without_next_sentence_2a_eval \
 --do_train=False \
 --do_eval=True \
