...
python3 ../run_pretraining.py \
 ...
 --init_checkpoint=gs://nlp-data-storage/"$CHECKPOINT_FOLDER"/checkpoints/"$CHECKPOINT_PREFIX"_without_next_sentence_1a/model.ckpt-270000 \
 --output_dir=gs://nlp-data-storage/"$CHECKPOINT_FOLDER"/checkpoints/"$CHECKPOINT_PREFIX"_without_next_sentence_1a_eval \
