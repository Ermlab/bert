...
python3 ../run_pretraining.py \
 ...
 --init_checkpoint=gs://nlp-data-storage/"$DATASET_NAME"/checkpoints/"$CHECKPOINT_PREFIX"_without_next_sentence_2a/ \
 --output_dir=gs://nlp-data-storage/"$DATASET_NAME"/checkpoints/"$CHECKPOINT_PREFIX"_without_next_sentence_2a_eval \
