...
python3 ../run_pretraining.py \
 ...
 --init_checkpoint=gs://nlp-data-storage/"$CHECKPOINT_FOLDER"/checkpoints/"$CHECKPOINT_PREFIX"_without_next_sentence_2a/ \
 --output_dir=gs://nlp-data-storage/"$CHECKPOINT_FOLDER"/checkpoints/"$CHECKPOINT_PREFIX"_without_next_sentence_2a_eval \
