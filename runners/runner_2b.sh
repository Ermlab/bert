...
python3 ../run_pretraining.py \
 ...
 --init_checkpoint=gs://nlp-data-storage/"$DATASET_NAME"/checkpoints/"$CHECKPOINT_PREFIX"_without_next_sentence_1b/model.ckpt-270000 \
 --output_dir=gs://nlp-data-storage/"$DATASET_NAME"/checkpoints/"$CHECKPOINT_PREFIX"_without_next_sentence_2b \
